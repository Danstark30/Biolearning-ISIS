# -*- coding: utf-8 -*-
"""
Created on Wed May 17 23:21:32 2023
...
scaled_data=pd.DataFrame(scalar.fit_transform(fisicas))
#PCA
...
fig.show()
pyo.plot(fig, filename='3d_fisicasPCA_plot.html') # fisicas
...
fisicas=fisicas.dropna()
labels = fisicas['Desempeño'] 
#labels2=labels.
